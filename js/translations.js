...
module.exports = {
  ...
  description: {
    ...
    es: 'EtheRoox se ha posicionado como la primera bolsa de cambio de cryptomonedas y tokens de la blockchain Ethereum.',
  ...
  only_7_days: {
    en: 'Note: EtheRoox will only show recent transactions.',
    cn: '注意：EtheRoox只会显示最近的交易。',
    fr: 'Remarque: EtheRoox affichera uniquement les transactions récentes.',
    es: 'Nota: EtheRoox sólo mostrará transacciones recientes.',
  },
  ...
  deposit_withdraw_4: {
    ...
    fr: 'Pour déposer, cliquer sur "Deposit" tab, choisir un jeton, entrer le montant à déposer depuis votre compte Ethereum vers EtheRoox, puis cliquer "Deposit".',
    es: 'Para abonar, haga clic en la pestaña "depósito", elegir un modo, ingrese la cantidad a depositar desde su cuenta a Etereum EtheRoox y haga clic en "depósito.',
  },
  deposit_withdraw_5: {
  ...
  trade_6: {
    ...
    fr: "Quand vous soumettez un ordre restant, il se diffuse dans le monde entier. Le canal de causerie principal s'appele Gitter chat room, mais EtheRoox supporte egalement des evenements ethereum en tant que moyen de diffusion alternative.",
    es: 'Cuando se envía una orden de reposo, que se transmitió al mundo. El canal de difusión actual es una sala de chat Gitter, EtheRoox también promueve eventos Ethereum como un medio alternativo de distribución.',
  },
  trade_7: {
